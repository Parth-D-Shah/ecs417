      ...
      <?php
        ...
        if(mysqli_num_rows($query) > 0)
        {
          while($currentrow = mysqli_fetch_assoc($query))
          {
            ...
            {
              echo "<br><h3>Post ID: $id <br><br> Title: $title<h3><br><p>$text</p><br><p>Time: $date</p><br><a href='delete.html'></a><br><hr>";
            }
            else
            {
        ...
        else
        {
          ...
          if(isset($_SESSION['logged_in']))
          {
            if($_SESSION['super'] == true)
            {
              echo'<br><a href="addpost.html">Add Post<a><br><a href="delete.html"></a>';
            }
          }
        }
      ?>
