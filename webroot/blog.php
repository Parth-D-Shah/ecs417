      ...
      <?php
        ...
        if(mysqli_num_rows($query) > 0)
        {
          while($currentrow = mysqli_fetch_assoc($query))
          {
            ...
            {
              echo "<br><h3>Post ID: $id <br><br> Title: $title<h3><br><p>$text</p><br><p>Time: $date</p><br><a href='delete.html'>Delete Post<a><form method='POST' action='comment.php'><input type='hidden' name='id' value='$id'><input type='submit' value='Add/View Comment'></form><br><hr>";
            }
            else
            {
